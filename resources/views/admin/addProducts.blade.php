          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              @if (Session::has('status'))
                ...
                @endif
              {!!Form::open(['action' => 'App\Http\Controllers\ProductsController@createProduct', 'method' => 'POST', 'enctype'=>'multipart/form-data'
                ])!!}
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    {{Form::label('','Select Category',['for'=>'select'])}}
                    {{Form::select('productCategory', $categories, null, ['placeholder' =>'Select category','class' => 'form-control select2'])}}
                  </div>
                  <label for="exampleInputFile">Product image</label>
                  <div class="input-group">
                    <div class="custom-file">
                      {{Form::file('productImage',['class'=>'custom-file-input', 'id' =>'productImage'])}}
                      {{Form::label('','Chose File',['class'=>'custom-file-label' ,'for'=>'productImage'])}}
                ...
                <div class="card-footer">
                  ...
                  {{Form::submit('Save',['class'=>'btn btn-primary','id'=> 'saveProduct'])}}
                </div>
              {!!Form::Close()!!}
            </div>
            <!-- /.card -->
