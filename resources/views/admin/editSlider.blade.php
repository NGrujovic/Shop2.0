              ...
              {!!Form::open(['action' => 'App\Http\Controllers\SlidersController@updateSlider', 'method' => 'POST', 'enctype'=>'multipart/form-data'
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1',$slider->description1,['class'=>'form-control', 'id' =>'description1' , 'placeholder' =>'Enter slider description 1'])}}
                    
                  </div>
                  <div class="form-group">
                    {{Form::label('','Slider Description 2',['for'=>'description1'])}}
                    {{Form::text('description2',$slider->description2,['class'=>'form-control', 'id' =>'description2' , 'placeholder' =>'Enter slider description 2'])}}
                  </div>
