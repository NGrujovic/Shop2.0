              ...
              {!!Form::open(['action' => 'App\Http\Controllers\ProductsController@updateProduct', 'method' => 'POST', 'enctype'=>'multipart/form-data'
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('productPrice',$product->productPrice,['class'=>'form-control', 'id' =>'productPrice' , 'placeholder' =>'Enter product price'])}}
                    
                  </div>
                  <div class="form-group">
                    {{Form::label('','Select Category',['for'=>'select'])}}
                    {{Form::select('productCategory', $categories, $product->productCategory, ['class' => 'form-control select2'])}}
                  </div>
                ...
                <div class="card-footer">
                  ...
                  {{Form::submit('Update',['class'=>'btn btn-primary','id'=> 'updateProduct'])}}
                </div>
              {!!Form::Close()!!}
            </div>
            <!-- /.card -->
