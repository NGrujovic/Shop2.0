    				...
    				<div class="cart-list">
	    				<table class="table">
						    ...
						    <tbody>
								...
								<tr class="text-center">
									<td class="product-remove"><a href="{{url('/deleteCart/'.$prod['product_id'])}}"><span class="ion-ios-close"></span></a></td>
									
									<td class="image-prod"><div class="img" style="background-image:url(/storage/productImages/{{$prod['productImage']}});"></div></td>
									...
									<form action="{{url('/updateQty/'.$prod['product_id'])}}" method="POST">
										{{ csrf_field() }}
										<td class="quantity">
									...
									<td class="total">${{$prod['qty']*$prod['productPrice']}}</td>
								  </tr>
								@endforeach
								@else
