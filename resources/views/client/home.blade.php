...
<!-- start content -->
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(/storage/sliderImages/{{$slider->sliderImage}});">
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="storage/productImages/{{$prod->productImage}}" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
