			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{url('/signup')}}" method="POST">
					...
					<span class="login100-form-logo">
						...
						<a href="{{url('/')}}" class="zmdi"><i class="zmdi zmdi-landscape"></i></a>
					</span>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Confirm E-Mail">
						<input class="input100" type="email" name="email2" placeholder="Confirm E-Mail">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
