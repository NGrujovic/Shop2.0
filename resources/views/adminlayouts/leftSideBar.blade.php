      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{request()->is('addcategory') ? 'menu-open' : ''}}
            ...
            {{-- <ul class="nav nav-treeview " style="{{request()->is('editCategory') ? '' : 'display:none'}}">
              <li class="nav-item">
                <a href="" class="nav-link {{request()->is('editCategory') ? 'active' : ''}}">
                  <i class="far fa-file nav-icon"></i>
                  <p>Edit Category</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview {{request()->is('addProducts') ? 'menu-open' : ''}}
